...
<div class="pageFormContent" id="import">
	  ...
	  <form style="overflow: hidden;" method="post" action="${path }/events/erpCustomer!saveCustomer.action" class="pageForm required-validate" onsubmit="return iframeCallback(this,returnOnclickAjaxDone);" enctype="multipart/form-data">
