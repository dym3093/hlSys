			...
			<tr>
				...
				<td>
					...
					<select name="filter_and_matchstate_EQ_I" rel="iselect" id="matchstate">
						...
						<option value="11" <c:if test="${filter_and_matchstate_EQ_I==11 }">selected="selected"</c:if>>暂不打印</option>
						<option value="13" <c:if test="${filter_and_matchstate_EQ_I==13 }">selected="selected"</c:if>>不打印报告</option>
