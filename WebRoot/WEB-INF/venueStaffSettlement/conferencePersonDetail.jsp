...
<body>
	...
	<form id="pagerFindForm" onsubmit="if(this.action != '${path}/venueStaffSett/conferCostMan!getPersonByConferenceId.action?id=${conferenceId}'){this.action = '${path}/venueStaffSett/conferCostMan!getPersonByConferenceId.action?id=${conferenceId}';} ;return navTabSearch(this);" action="${path}/venueStaffSett/conferCostMan!getPersonByConferenceId.action?id=${conferenceId}" method="post" rel="pagerForm" id="pagerFindForm">
	<div class="searchBar">
