...
function customerAdd() {
    ...
    $.pdialog.open("${path}/settlementManagement/erpSettlementTaskBX!customerAdd.action?customerId="+ids[0]+"&navTabId="+navTabId, "customerAddDialogId", "按会员设置实结价",
    		{width:530,height:330,mask:true,fresh:false} );	
...
<div class="pageHeader" style="background:white">
	...
	<form id = "addForm" action="${path}/settlementManagement/erpSettlementTaskBX!reloadAddSettlementBXPageNew.action?id=${taskBX.id}&type=${type}" rel = "pagerForm" >
	<div class="searchBar">
	...
	<div class="panelBar">
		<c:if test="${currentUser.accountName!='parkson'}">
			<ul class="toolBar">
				...
				<li style="margin-right:15px;"> <a class="delete" onclick="removeCustomer()" ><span>移除会员</span></a> </li>
