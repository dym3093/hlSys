...
$(document).ready(function(){
 ...
 function uploadFile(){
		...
		$.ajaxFileUpload({
			url:'${path}/settlementManagement/erpReceiptInfo!importClaimInfoExcel.action',
			type:'post',
...
<div class="pageFormContent" id="import">
  <div> 
    <form method="post" action="${path}/settlementManagement/erpReceiptInfo!toImportClaimInfoExcel.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);" enctype="multipart/form-data">
      <!-- 打印任务ID -->
      ...
      <div class="formBar">
        <ul>
          <li style="width:450px">
            <span style="float:left;line-height:25px;">认领明细数据表：</span>
