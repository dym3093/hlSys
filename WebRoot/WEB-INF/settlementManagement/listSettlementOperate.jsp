...
$(document).ready(function(){
	...
	}else if(hiddenTextTwo=='402881b25373b2cd0153a223c8f00003'){
		$("select[name='filter_and_geCompanyId_EQ_S']", navTab.getCurrentPanel()).find("option[value='402881b25373b2cd0153a223c8f00003']").attr("selected",true);
	}else if(hiddenTextTwo=='402881b25373b2cd0153a223c8f00004'){
		$("select[name='filter_and_geCompanyId_EQ_S']", navTab.getCurrentPanel()).find("option[value='402881b25373b2cd0153a223c8f00004']").attr("selected",true);
	}
			...
			<tr>
				...
				<td>
					...
					<select id="geneCompany" name="filter_and_geCompanyId_EQ_S" rel="iselect">
						...
						<option value='402881b25373b2cd0153a223c8f00004'>金域基因公司</option>
		 			</select>
				</td>
				<td>
