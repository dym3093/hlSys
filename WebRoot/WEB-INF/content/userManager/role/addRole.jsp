...
#userDiv div a{
	...
	<body>
		...
		<form action="role!saveRole.action" method="post" id="_form"
			class="form">
			<table width="100%">
				<tr>
					<td class="label">
					...
					<td>
						<input type="text" name="role.name" maxlength="50"
				...
				<tr>
					...
					<td>
						<input type="text" name="role.code" maxlength="50"
			...
			<input type="hidden" name="role.parentId" value="${parentId }">
		</form>
	</body>
</html>
