...
<html>
	<head>
		<script type="text/javascript" src="${path}/scripts/CheckForm.js">
</script>
	</head>
	...
	<body>
		...
		<form action="group!saveGroup.action" method="post" id="_form"
			class="form">
			<table width="100%">
				<tr>
					<td width="30%">
				...
				<tr>
					...
					<td>
						<textarea rows="10" cols="55" name="group.description"
