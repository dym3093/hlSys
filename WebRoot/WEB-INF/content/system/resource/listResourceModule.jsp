...
<html>
	...
	<body>
		<table class="navigation">
			<tr>
				<td class="location">
					<web:location value="系统菜单管理-菜单模块" />
				</td>
			</tr>
		</table>
				...
				<tr>
					...
					<td class="handle-td">
						...
						<input type="button" class="button" value="添 加"
							onclick="addAction('resource!addResourceModuel.action')" />
						
						<input type="button" class="button" value="修 改"
							onclick="updateAction('resource!modifyResourceModuel.action','id','id')" />
						
						<input type="button" class="button" value="更改状态"
							onclick="deleteAction('resource!deleteProduct.action','ids','id')" />
