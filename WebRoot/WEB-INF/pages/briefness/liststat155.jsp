				...
				<table class="list" width="100%" layoutH="100" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th>序号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "0" columnChName = "检测日期">检测日期</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "省份">省份</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "城市">城市</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "支公司">支公司</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "检测人数">检测人数</th>
					</tr>
				  </thead>
				  <tbody>
