				...
				<table class="list" width="100%" layoutH="100" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th>序号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "0" columnChName = "微信标识">微信标识</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "客户姓名">客户姓名</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "客户手机号码">客户手机号码</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "检测码">检测码</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "身份证号">身份证号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "出生日期">出生日期</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "6" columnChName = "代理人姓名">代理人姓名</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "7" columnChName = "代理人工号">代理人工号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "8" columnChName = "代理人手机号码">代理人手机号码</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "9" columnChName = "检测时间">检测时间</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "10" columnChName = "客户报告完成时间">客户报告完成时间</th>
					</tr>
				  </thead>
				  <tbody>
