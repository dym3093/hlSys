				...
				<div class="panelBar">
					...
					<c:if test="${page.results != null && !empty page.results }">
						<web:exportExcelTag4Jdbc 
										...
										fileName="stat172"
										configId="stat172"></web:exportExcelTag4Jdbc>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "总邀约人数">总邀约人数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "生物电邀约（总）">生物电邀约（总）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "微磁邀约（总）">微磁邀约（总）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "生物电邀约（日）">生物电邀约（日）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "微磁邀约（日）">微磁邀约（日）</th>				    
					</tr>
				  </thead>
				  <tbody>
