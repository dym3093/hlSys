...
String savePath = tawCommonsAccessoriesManagerCOSService.getFilePath() + "/editor/attached/";
System.out.println(savePath);

//文件保存目录URL
String saveUrl  = request.getContextPath() + "/kindeditor/jsp/output.jsp?fileName=";
...
if(!uploadDir.isDirectory()){
	boolean isOK = uploadDir.mkdirs();
	if(!isOK){
		out.println(getError("上传目录不存在，目录创建失败。"));
		return;
	}
}
//检查目录写权限
