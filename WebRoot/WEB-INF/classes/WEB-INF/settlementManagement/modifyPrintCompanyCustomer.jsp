...
<div class="pageHeader" style="background:white">
	<form class="pageForm required-validate" id="modifyCustomer" action="${path}/settlementManagement/erpPrintCompanySettleTask!modifyCustomerInfo.action" method="post">
