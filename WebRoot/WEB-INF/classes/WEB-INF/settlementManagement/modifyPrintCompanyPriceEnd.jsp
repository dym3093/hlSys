...
<div class="pageHeader" style="background:white">
	<form class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);" id="modifyPrice" action="${path}/settlementManagement/erpPrintCompanySettleTask!modifyPriceEnd.action" method="post">
