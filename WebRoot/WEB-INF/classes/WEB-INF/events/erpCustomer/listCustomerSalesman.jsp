...
<div class="pageHeader">
	<form id="pagerFindForm" onsubmit="if(this.action != '${path}/events/erpCustomer!toListCustomerSalesman.action'){this.action = '${path}/events/erpCustomer!toListCustomerSalesman.action' ;} ;return navTabSearch(this);" action="${path}/events/erpCustomer!toListCustomerSalesman.action" method="post"  rel="pagerForm" id="pagerFindForm">
	<div class="searchBar">
