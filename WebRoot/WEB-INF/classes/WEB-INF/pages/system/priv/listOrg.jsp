...
Ext.onReady(function() {
	        ...
	        var treeloader = new Ext.tree.TreeLoader( {
		      dataUrl : "assignAction!treeOrgMain.action"
	         });
	         tree = new Ext.tree.TreePanel( {
				...
				tree.on('beforeload', function(node) {
			      ...
			      tree.loader.dataUrl = 'assignAction!treeOrg.action?hlTreePath=' + hlTreePath;
		});
	       // tree = createTree('west-div','org!treeOrg.action', '-1', '链家地产', true, null, 0, true,null);
            ...
            tree.on("click", function(node, event) {
	           node.expand();
	           window.mainFrame.location.href='assignAction!showGrantResource.action?tag=3&isleaf='+node.isLeaf+'&roleId='+node.id;
            });
		});
		</script>
	</head>
	<body>
		...
		<div id="center-div">
			<iframe id="mainFrame" name="mainFrame" height="100%" width="100%" src="#"></iframe>
		</div>
	</body>
</html>