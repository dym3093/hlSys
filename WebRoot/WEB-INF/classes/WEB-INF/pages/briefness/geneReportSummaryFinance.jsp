...
<div class="pageHeader">
	<form id="pagerFindForm" onsubmit="if(this.action != '${path }/statistics/queryaction!queryGeneReportSummaryFinance.action'){this.action = '${path }/statistics/queryaction!queryGeneReportSummaryFinance.action' ;};return navTabSearch(this); " action="${path }/statistics/queryaction!queryGeneReportSummaryFinance.action" method="post" rel="pagerForm">
	<div class="searchBar">
	<input type="hidden" name="configId" value="${actionMap['configId'] }">
	  <table class="pageFormContent num1_tab">
		<tr>
			...
			<td >
				<label>查找月份：</label>
				<input type="text" name="month"  value="${filter_and_month_LIKE_T}" />
			</td>
			<td>
			</td>
             <td>
				...
				<table class="list" width="100%" layoutH="190" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "month" columnChName = "月份">月份</th>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "haveReportNum" columnChName = "已出报告人数">已出报告人数</th>
