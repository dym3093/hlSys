				...
				<table class="list" width="100%" layoutH="100" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "打印公司">打印公司</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "6" columnChName = "套餐">套餐</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "7" columnChName = "打印任务号">打印任务号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "8" columnChName = "金额">金额</th>					   
					</tr>
				  </thead>
				  <tbody>
