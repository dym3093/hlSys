				...
				<div class="panelBar">
					...
					<c:if test="${page.results != null && !empty page.results }">
						<web:exportExcelTag4Jdbc 
										...
										fileName="stat109"
										configId="stat109"></web:exportExcelTag4Jdbc>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "数量">数量</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "总金额">总金额</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "规格">规格</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "描述">描述</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "6" columnChName = "可用数量">可用数量</th>
					</tr>
				  </thead>
				  <tbody>
