...
<div class="pageHeader" style="overflow: hidden;">
	<form id="queryErpProductSelect_id" onsubmit="return dialogSearch(this);" action="${path}/warehouse/application!addYgbxProduct.action" method="post" rel="pagerForm">
	<input type="hidden" name="params.isClose" value="0"/>
	<input type="hidden" name="params.hiddenName" value="yg"/>
	<div class="searchBar">
