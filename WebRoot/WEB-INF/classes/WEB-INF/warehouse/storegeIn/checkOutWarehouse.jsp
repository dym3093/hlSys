...
<div class="pageContent">
	<form id="product_edit_from_id" 
		...
		action="${path}/warehouse/storegeIn!checkOut.action" method="post" theme="simple">
	    ...
	    <div class="pageFormContent" layoutH="40" style="overflow: hidden;">
			...
			<dl class="nowrap">
				...
				<dd>
					<input type="text" id="stroregeInPrice" name="stroregeIn.priceBak" value="${stroregeIn.price == null ? 0.00 : stroregeIn.price }" class="textInput required number" readonly="readonly" maxlength="16"/>
				</dd>
			</dl>
			...
			<dl class="nowrap">
				...
				<dd>
					<input type="text" id="stroregeInQuantity" name="stroregeIn.quantity" value="${stroregeIn.quantity == null ? 0 : stroregeIn.quantity }" maxlength="16" class="textInput required" readonly="readonly" onkeyup="this.value=this.value.replace(/[^\d|chun]/g,'')"  />
				</dd>
			</dl>
			<dl class="nowrap">
			...
			<dl class="nowrap" id="cardNum">
				...
				<dd>
					<input type="text" id="stroregeInCardNum" name="stroregeIn.cardNum" value="${stroregeIn.cardNum }" class="textInput" readonly="readonly" />
				</dd>
			...
			<dl class="nowrap" id="cardStart">
				...
				<dd>
					<input type="text" id="stroregeInCardStart" name="stroregeIn.cardStart" value="${stroregeIn.cardStart }" class="textInput cardLength cardNum" readonly="readonly" />
			...
			<dl class="nowrap">
				...
				<dd>
					<input type="hidden" id="supplierId" name="stroregeIn.supplierId" value="${stroregeIn.supplierId}" />
					<input type="text" id="supplierName" name="supplierName" value="${supplierName}" class="textInput" readonly="readonly"/>
					<%--<a class="btnLook" href="${ path }/warehouse/supplier!querySupplier.action" callback="pro_callback" lookupGroup="supplierId">查找带回</a>--%>
					<%--<img src="${path}/images/clear.png" title="清除供货商信息" id="supplierIdClear" style="padding-top: 6px; cursor: pointer;"/>--%>
				</dd>
			</dl>

			<dl class="nowrap" >
				<dt style="background-color:#FFFFFF;">OA序列号：</dt>
				<dd>
					<input type="text" id="serialNoOA" name="stroregeIn.serialNoOA" value="${stroregeIn.serialNoOA}" class="textInput required " />
				</dd>
