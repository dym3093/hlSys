...
<html>
	...
	<body>
		...
		<table class="navigation">
			<tr>
				<td class="location">
					<web:location value="系统菜单管理-修改菜单模块" />
				</td>
				<td class="back">
		...
		<div class="form-content">
			<form id="_form" class="form" method="post"
				...
				<input type="hidden" name = "resource.type" value = "${resource.type }" />
				<input type="hidden" name = "resource.parentId" value = "${resource.parentId }" />
				...
				<table>
					...
					<tr>
						...
						<td>
							<input type="text" name="resource.orderCode" value="${resource.orderCode }" maxlength="100"/>
						</td>
					</tr>
					<tr>
						<td class="label">
						...
						<td>
							<input type="text" disabled="disabled" name="resource.url" value="${resource.url }" maxlength="100" />
						</td>
					</tr>
					<tr>
						<td class="label">
