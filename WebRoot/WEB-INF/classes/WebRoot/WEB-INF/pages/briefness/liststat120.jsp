...
function downLoadSumary(){
	...
	if (count == 0) {
		...
		$.ajax({
			...
			url: "${path}/statistics/queryaction!createExSeFilePathTwo.action",
				...
				<table class="list" width="100%" layoutH="100" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "已出报告人数">已出报告人数</th>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "8" columnChName = "场次号">场次号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "8" columnChName = "检测公司">检测公司</th>
					</tr>
				  </thead>
				  <tbody>
