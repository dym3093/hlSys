				...
				<div class="panelBar">
					...
					<c:if test="${page.results != null && !empty page.results }">
						<web:exportExcelTag4Jdbc 
										...
										fileName="stat110"
										configId="stat110"></web:exportExcelTag4Jdbc>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "出库总金额">出库总金额</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "物流费">物流费</th>
					</tr>
				  </thead>
				  <tbody>
