...
<div class="pageHeader">
	...
	<div class="searchBar">
	  <table class="pageFormContent num1_tab">
		<tr>
			<td><label>检测截止日期：</label></td>
			<td>
				<input type="text" name="filter_and_createTime_LE_T"  id="d1" style="width: 170px;" onFocus="WdatePicker({minDate:'2010-01-01',maxDate:'2110-01-01'})"  readonly="readonly" value="${filter_and_createTime_LE_T}" /><a class="inputDateButton" href="javascript:;" >选择</a>
			</td>
      		<td>
			...
			<div class="pageContent">
				<div class="panelBar">
					...
					<c:if test="${page.results != null && !empty page.results }">
						<web:exportExcelTag4Jdbc 
										...
										fileName="stat173"
										configId="stat173"></web:exportExcelTag4Jdbc>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    <th>序号</th>   
					    <th nowrap="nowrap" export = "true" columnIndex = "0" columnChName = "日期">日期</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "总检测人数">总检测人数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "生物电检测（总）">生物电检测（总）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "微磁检测（总）">微磁检测（总）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "生物电检测（日）">生物电检测（日）</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "微磁检测（日）">微磁检测（日）</th>				    
					</tr>
				  </thead>
				  <tbody>
