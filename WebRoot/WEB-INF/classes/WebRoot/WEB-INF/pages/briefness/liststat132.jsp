				...
				<div class="panelBar">
					...
					<c:if test="${page.results != null && !empty page.results }">
						<web:exportExcelTag4Jdbc 
										...
										fileName="stat132"
										configId="stat132"></web:exportExcelTag4Jdbc>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "入库总数量">入库总数量</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "出库总数量">出库总数量</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "可用库存总数">可用库存总数</th>
					</tr>
				  </thead>
				  <tbody>
