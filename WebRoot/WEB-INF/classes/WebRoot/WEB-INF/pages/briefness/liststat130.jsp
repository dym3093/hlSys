				...
				<table class="list" width="100%" layoutH="210" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th>序号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "0" columnChName = "市公司">市公司</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "扫码支公司">扫码支公司</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "营销员姓名">营销员姓名</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "营销员工号">营销员工号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "预约客户数">预约客户数</th>
					</tr>
				  </thead>
				  <tbody>
