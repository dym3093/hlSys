...
<div class="pageHeader">
	<form id="pagerFindForm" onsubmit="if(this.action != '${path}/events/erpCustomer!toListCustomerNoReportSalesman.action'){this.action = '${path}/events/erpCustomer!toListCustomerNoReportSalesman.action' ;} ;return navTabSearch(this);" action="${path}/events/erpCustomer!toListCustomerNoReportSalesman.action" method="post"  rel="pagerForm" id="pagerFindForm">
	<div class="searchBar">
