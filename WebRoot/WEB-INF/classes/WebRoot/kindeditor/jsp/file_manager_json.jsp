...
String rootPath = tawCommonsAccessoriesManagerCOSService.getFilePath() + "/editor/attached/";
//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
String rootUrl  = request.getContextPath() + "/kindeditor/jsp/output.jsp?fileName=";
//图片扩展名
