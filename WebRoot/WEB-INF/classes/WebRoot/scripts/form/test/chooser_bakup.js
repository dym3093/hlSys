...
var Chooser_sichuan = function(){
    ...
    layout.beginUpdate();
    layout.add('center', new Ext.ContentPanel('dept', {title: '部门',autoCreate:true}));
    layout.add('center', new Ext.ContentPanel('class', {title: '专业和系统',autoCreate:true}));
    layout.add('center', new Ext.ContentPanel('business', {title: '厂家',autoCreate:true}));
    layout.endUpdate();
