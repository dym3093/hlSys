 ...
 * new hpin.LunarCalendar("calendar");
 */

hpin.LunarCalendar = function(el,config){
	this.el = Ext.get(el);
    hpin.LunarCalendar.superclass.constructor.call(this, config);
    this.render(this.el);
};

Ext.extend(hpin.LunarCalendar, Ext.DatePicker, {	
