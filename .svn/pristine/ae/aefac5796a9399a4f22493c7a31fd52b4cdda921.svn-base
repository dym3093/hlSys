package org.hpin.common.log.util;
 ...
 *
 * <p>@author : sky</p>
 * <p>@createDate : Aug 29, 2012 9:15:55 PM</p>
 * <p>@version : v1.0 </p>
 * <p>All Rights Reserved By Acewill Infomation Technology(Beijing) Co.,Ltd</p>
 */
public class HpinLog {

	public HpinLog() {
		
	}
	private static HpinLog instance = new HpinLog();

	public static HpinLog getInstance() {
		return instance;
	}
