 ...
 * 
 */
@Service(value = "org.hpin.system.accessories.service.HPINAttributes")
@Transactional()
public class HPINAttributes {
	/**
	 * 事例
	 */
	...
	public String getHpinUrl() {
		return hpinUrl;
	}

	public void setHpinUrl(String hpinUrl) {
		this.hpinUrl = hpinUrl;
	}
