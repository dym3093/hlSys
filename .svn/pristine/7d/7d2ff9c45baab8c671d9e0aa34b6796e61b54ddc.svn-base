...
$(document).ready(function(){
	$("input[type=checkbox]",$.pdialog.getCurrent()).click(function(){
	...
	$("#tjlxrs").click(function(){
		$.pdialog.close("dlg_page444"); 
	});
});
</script>
<div class="pageContent">
	<form class="pageForm required-validate" id="customerLink" onsubmit="return validateCallback(this, tabAjaxDone);" action="${path }/resource/customerLink!saveCustomerLinks.action" method="post" novalidate="novalidate">
		...
		<div class="tip"><span>客户联系人信息</span></div>
			<p>
				...
				<input type="text" bringBackName="customer.customerName" value="${ customer.customerName }" readonly="readonly"/>
			...
			<p>
				<label>座机：</label>
				<input type="text" class="textInput" name="customerLink.tel" maxlength="20" size="30" />
			</p>
			<p>
				<label>手机：</label>
			...
			<p>
				<label>QQ：</label>
				<input type="text" class="textInput digits" maxlength="20" name="customerLink.qq" size="30" />
			</p>
			<p>
				<label>个人账号：</label>
			...
			<p class="nowrap">
			<label>备注：</label>
			<textarea name="customerLink.remark" cols="100" rows="2"></textarea>
		     </p>
		  </div>
		<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button id="tjlxrs" type="submit">保存</button></div></div></li>
				<li>
