...
public class YmGeneReportServiceImplServiceLocator extends org.apache.axis.client.Service implements org.hpin.webservice.service.YmGeneReportServiceImplService {
	    ...
	    private java.lang.String YmGeneReportServiceImplPort_address = "http://gene.healthlink.cn:8088/websGene/geneReport";
	    ...
	    public org.hpin.webservice.service.YmGeneReportServiceImpl getYmGeneReportServiceImplPort() throws javax.xml.rpc.ServiceException {
	    ...
	    public org.hpin.webservice.service.YmGeneReportServiceImpl getYmGeneReportServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
	        try {
	            org.hpin.webservice.service.YmGeneReportServiceImplServiceSoapBindingStub _stub = new org.hpin.webservice.service.YmGeneReportServiceImplServiceSoapBindingStub(portAddress, this);
	    ...
	    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
	        try {
	            if (org.hpin.webservice.service.YmGeneReportServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
	                org.hpin.webservice.service.YmGeneReportServiceImplServiceSoapBindingStub _stub = new org.hpin.webservice.service.YmGeneReportServiceImplServiceSoapBindingStub(new java.net.URL(YmGeneReportServiceImplPort_address), this);
	                _stub.setPortName(getYmGeneReportServiceImplPortWSDDServiceName());
	                return _stub;
	            }
	        }
