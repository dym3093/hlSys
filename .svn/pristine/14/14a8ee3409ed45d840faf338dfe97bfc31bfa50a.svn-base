...
function submitPrintTask(){
	...
	$.ajax({	
		...
		url: "${path}/report/xreportPrintTask!toAddPrintTask.action",
		success: function(data){
			var str = eval("("+data+")");
			if(str.count==1){
...
<table class="list" width="100%" layoutH="170" id="exportExcelTable"> 
			...
			<tr>
				...
				<th  export = "true" columnEnName = "branchCompany" id2NameBeanId="org.hpin.statistics.briefness.dao.CustomerRelationshipDao" columnChName = "支公司" >支公司</th>
