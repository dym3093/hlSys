...
<script type="text/javascript" language="javascript">
 function uploadFile(){
		var value = $("input[name='salesManExc']").val();
		$.ajaxFileUpload({
			url:'${path}/resource/preSalesmanMgr!addSalesmanInfo.action',
			type:'post',
			secureuri: false,
			data:{"filePath":value},
...
<div class="pageFormContent" id="import">
  <div> 
    <form method="post" action="${path}/resource/preSalesmanMgr!addSalesmanInfo.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);" enctype="multipart/form-data">
      <div class="formBar">
        <ul>
