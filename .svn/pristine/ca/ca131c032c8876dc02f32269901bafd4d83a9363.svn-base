...
<div class="tip"><span>金域任务查询</span></div>
				...
				<jsp:include page="/common/pagination.jsp" />					
					...
					<c:if test="${page.results != null && !empty page.results }">
						<%-- <web:exportExcelTag4Jdbc 
										...
										fileName="reportFileTaskJY"
										configId="reportFileTaskJY"></web:exportExcelTag4Jdbc> --%>
					</c:if>
					</ul>
				</div>					
				<table class="list" width="100%" layoutH="130" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "报告总数">报告总数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "报告单总数">报告单总数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "3" columnChName = "匹配成功数">匹配成功数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "4" columnChName = "未匹配数">未匹配数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "5" columnChName = "已完成数">已完成数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "6" columnChName = "已完成数">未完成数</th>
					</tr>
				  </thead>
				  <tbody>
