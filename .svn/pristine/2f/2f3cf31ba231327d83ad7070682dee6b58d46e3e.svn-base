...
public class ErpStoregeInService extends BaseService {
	 ...
	 * @param userInfo
	 */
	public void saveStroregeIn(ErpStoregeIn erpStoregeIn, User userInfo, int status) {
		...
		erpStoregeIn.setStoregeStatus(status); //入库状态: 1正常入库, 0退货入库; create by Henry.xu 20170317
