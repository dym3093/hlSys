...
<form id="pagerFindForm" class="pageForm required-validate" onsubmit="return iframeCallback(this, testAjax);" 
	...
	action="${path}/warehouse/application!customerHKExcel.action" method="post" enctype="multipart/form-data">
...
function addProduct() {
	...
	$.pdialog.open("${path}/warehouse/application!addProduct.action?params.isClose=0&navTabId="+navTabId, "addProductDetail", "产品信息列表", 
