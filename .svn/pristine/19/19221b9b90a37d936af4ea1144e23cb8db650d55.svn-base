...
<div class="pageHeader">
	...
	<input type="hidden" name="configId" value="${actionMap['configId']}">
	  <table class="pageFormContent num1_tab">
			...
			<tr>
            	<td><label>导入开始日期：</label>
					<input type="text" name="filter_and_createTime_GE_T" value="${ actionMap.filter_and_createTime_GE_T }"  id="d7111"  onFocus="WdatePicker({minDate:'2010-01-01',maxDate:'#F{$dp.$D(\'d7112\')}'})" class="required"  readonly="readonly" />
					<a class="inputDateButton" href="javascript:;">选择</a>
				</td>
				<td><label>导入结束日期：</label>
					<input type="text" name="filter_and_createTime_LE_T" value="${ actionMap.filter_and_createTime_LE_T }"   id="d7112"  onFocus="WdatePicker({minDate:'#F{$dp.$D(\'d7111\')}'})" readonly="readonly" />
					<a class="inputDateButton" href="javascript:;">选择</a>	
				</td>
             <td>
				...
				<table class="list" width="100%" layoutH="100" id = "exportTable"> 
				   <thead>
					<tr>
					    ...
					    <th>序号</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "0" columnChName = "类型">类型</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "1" columnChName = "人数">人数</th>
					    <th nowrap="nowrap" export = "true" columnIndex = "2" columnChName = "是否有报告">是否有报告</th>
					</tr>
				  </thead>
				  <tbody>
