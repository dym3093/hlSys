...
public class ReportDetailPDFDaoImpl extends BaseDao {

	public List<ReportDetail> getAll() {
		String sql = "select * from  erp_reportdetail_pdf ";
	...
	public int pdfToTable(Object[] obj) {
		// TODO Auto-generated method stub
		int n=0;                
		String sql="insert into ERP_REPORTDETAIL_PDF(id,batchno,filepath,ismatch,filename,code) "
				+ "values(?,?,?,?,?,?)";
	...
	public int del() {
		// TODO Auto-generated method stub
		int n=0;
		String sql="delete from ERP_REPORTDETAIL_PDF";
